...
class WordAPI() {
    ...
    fun loadWords() {
        ...
        words.add(Word(86, "mancuerna", "dumbbell", "advanced", "noun", true))
        words.add(Word(87, "pasto", "grass", "beginner", "noun", true))
        words.add(Word(88, "pelota", "ball", "beginner", "noun", true))
        words.add(Word(89, "árbol", "tree", "beginner", "noun", true))
        words.add(Word(90, "ganar", "to win", "beginner", "verb", true))
        words.add(Word(91, "campo", "field", "beginner", "noun", true))
        words.add(Word(92, "oro", "gold", "beginner", "noun", true))
        words.add(Word(93, "entrenar", "to train", "intermediate", "verb", true))
        words.add(Word(94, "cosecha", "harvest", "intermediate", "noun", true))
        words.add(Word(95, "batalla", "battle", "intermediate", "noun", true))
        words.add(Word(96, "inversión", "investment", "intermediate", "noun", true))
        words.add(Word(97, "bosque", "forest", "intermediate", "noun", true))
        words.add(Word(98, "valiente", "brave", "intermediate", "adjective", true))
        words.add(Word(99, "competir", "to compete", "intermediate", "verb", true))
        words.add(Word(100, "precipicio", "cliff", "advanced", "noun", true))
        words.add(Word(101, "estratega", "strategist", "advanced", "noun", true))
        words.add(Word(102, "rentable", "profitable", "advanced", "adjective", true))
        words.add(Word(103, "arado", "plow", "advanced", "noun", true))
        words.add(Word(104, "sobresalir", "to excel", "advanced", "verb", true))
        words.add(Word(105, "derrota", "defeat", "advanced", "noun", true))
    }
