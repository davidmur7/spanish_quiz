...
class WordAPI () {
    ...
    fun loadWords() {
        ...
        words.add(Word(24, "fachada", "façade / front of a building", "advanced", "noun", true))
        ...
        words.add(Word(28, "desenlace", "ending / outcome", "advanced", "noun", true))
        ...
        words.add(Word(77, "renunciar", "to resign/give up", "advanced", "verb", true))
        words.add(Word(78, "desplegar", "to unfold/deploy", "advanced", "verb", true))
